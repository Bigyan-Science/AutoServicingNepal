...
class BajajPage extends StatefulWidget {
  const BajajPage({super.key});

  @override
  State<BajajPage> createState() => _BajajPageState();
}

class _BajajPageState extends State<BajajPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
